(function($) {
    $.addFlex = function(t, p) {
        ...
        if (p.usepager) {
            ...
            if ($.support.msie && $.support.version < 7) $('.pButton', g.pDiv).hover(function() {
        ...
        if ($('th', g.hDiv).length) {
            ...
            if ($.support.msie && $.support.version < 7.0) $('tr', g.nDiv).hover(function() {
    ...
    $.fn.noSelect = function(p) {
        ...
        if (prevent) {
            return this.each(function() {
                if ($.support.msie || $.support.safari) $(this).bind('selectstart',
                function() {
                    return false
                });
                    ...
                    $('body').trigger('focus')
                } else if ($.support.opera) $(this).bind('mousedown',
                function() {
                    return false
                });
            ...
            return this.each(function() {
                if ($.support.msie || $.support.safari) $(this).unbind('selectstart');
