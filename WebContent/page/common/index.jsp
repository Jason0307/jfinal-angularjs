...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/generate_pie.js"></script>
<script type="text/javascript" charset="UTF-8" src="<%=request.getContextPath() %>/js/prefixfree.min.js"></script>
<script type="text/javascript" charset="UTF-8" src="<%=request.getContextPath() %>/js/angular.js"></script>
